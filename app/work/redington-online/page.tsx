...
export const metadata: Metadata = {
  ...
  description: "How Sunita Rout is unifying four fragmented B2B commerce journeys into one research informed product system.",
};
...
const journeyRows = [
  ...
  ["Success signal", "Relevant discovery", "Fewer dead ends", "Completion quality", "Repeat independent use"],
];
    ...
    <main className="case-shell case-steel">
      ...
      <section className="case-hero steel-hero">
        ...
        <div className="case-hero-copy">
          <p className="case-kicker">Redington Online · B2B commerce · 2026 to now</p>
        ...
        <div className="case-hero-proof">
          ...
          <div><strong>Across the journey</strong><span>research → delivery → measure</span></div>
      ...
      <section className="case-section case-framing" id="problem">
        ...
        <div className="problem-layout">
          ...
          <div className="continuity-model" aria-label="Business problem to continuity design model">
            ...
            <i>×</i>
            <div><span>FRICTION</span><strong>Fragmentation by capability</strong></div>
            <i>↓</i>
      ...
      <section className="case-section ecosystem-section">
        <div className="case-section-head split-head">
          ...
          <p>The visual model makes ownership visible before design begins, so experience decisions survive organizational complexity.</p>
        </div>
      ...
      <section className="case-section operating-section" id="model">
        ...
        <div className="operating-loop" aria-label="Research informed product operating loop">
        ...
        <div className="measure-board">
          ...
          <article><span>PLATFORM</span><strong>Can they stay independent?</strong><p>Status clarity · repeat use · support need</p></article>
        </div>
      </section>
      ...
      <section className="case-section outcome-section steel-outcome" id="outcome">
        <div className="outcome-intro">
          ...
          <p>This is ongoing work, so I do not turn unfinished measurement into a polished claim. The value delivered now is a connected journey model, a research informed operating rhythm, and a measurement structure built into the work.</p>
        </div>
        ...
        <div className="role-strip"><span>My contribution</span><p>UX strategy · user research · journey architecture · interaction design · scalable UX practices · AI enabled commerce · collaborative leadership</p></div>
      </section>
